...
public class ViewGuide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addImage("fullcup", currentStepLayout);
        ...
        addImage("lid", currentStepLayout);
        ...
        addImage("emptycup", currentStepLayout);
    }
    ...
    public boolean addImage(final String imageName, LinearLayout selectedLayout){
        try{
